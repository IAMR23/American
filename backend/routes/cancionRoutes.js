...
router.get("/numero", cancionController.listarCancionesNumero);
router.get("/ultsubidas", cancionController.listarCancionesUltimasRecientes);
...
router.get("/default/all", cancionController.getVideosDefaultAll);
